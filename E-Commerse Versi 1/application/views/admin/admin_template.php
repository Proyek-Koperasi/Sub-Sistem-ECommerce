...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <link rel="stylesheet" type="text/css" href="<?php echo base_url(); ?>assets/admin/css/reset.css" />
        <link rel="stylesheet" type="text/css" href="<?php echo base_url(); ?>assets/admin/css/text.css" />
        <link rel="stylesheet" type="text/css" href="<?php echo base_url(); ?>assets/admin/css/form.css" />
        <link rel="stylesheet" type="text/css" href="<?php echo base_url(); ?>assets/admin/css/style.css" />

        <link rel="stylesheet" type="text/css" href="<?php echo base_url(); ?>assets/admin/css/jquery-ui-1.8.2.custom.css" />

        <link rel="stylesheet" type="text/css" href="<?php echo base_url(); ?>assets/admin/css/datePicker.css"/>

        <script type="text/javascript" src="<?php echo base_url(); ?>assets/admin/javascripts/jquery-1.4.2.min.js"></script>
        <script type="text/javascript" src="<?php echo base_url(); ?>assets/admin/javascripts/jquery-ui-1.8.2.custom.min.js"></script>
        <script type="text/javascript" src="<?php echo base_url(); ?>assets/admin/javascripts/admin.js"></script>
        <!-- jquery.datePicker.js -->
        <script type="text/javascript" src="<?php echo base_url(); ?>assets/admin/javascripts/jquery.datePicker.js"></script>
        <!-- required plugins -->
        <script type="text/javascript" src="<?php echo base_url(); ?>assets/admin/javascripts/date.js"></script>
