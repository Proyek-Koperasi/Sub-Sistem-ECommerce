...
//        $this->isLogin();
    ...
    function getNewProducts($limit) {
        ...
        $products = $this->ci->Products->getNewProducts($limit);
        return $products;
    }
    ...
    function getProductsByCategoryId($categoryId) {
        $this->ci->load->model('Products');
        $products = $this->ci->Products->getProductsByCategoryId($categoryId);
        return $products;
    }
    function getProductsById($id) {
        $this->ci->load->model('Products');
        $products = $this->ci->Products->getProductsById($id);
        return $products;
    }

    function getCategories() {
        $this->ci->load->model('kategori');
        $categories = $this->ci->kategori->getCategories();
        return $categories;
    }

    function get_KategoriProduk($gender) {
        $this->ci->load->model('kategori');
        $categories = $this->ci->kategori->get_KategoriProduk($gender);
        return $categories;
    }

    function get_KategoriBrands() {
        $this->ci->load->model('kategori');
        $categories = $this->ci->kategori->get_KategoriBrands();
        return $categories;
    }

     function get_KategoriGender() {
        $this->ci->load->model('kategori');
        $categories = $this->ci->kategori->get_KategoriGender();
        return $categories;
    }
    ...
    function getDiscountedProducts() {
        $this->ci->load->model('Products');
        $products = $this->ci->Products->getDiscountedProducts();
        return $products;
    }
